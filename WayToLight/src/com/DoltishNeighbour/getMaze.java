...
import static com.DoltishNeighbour.Game.nA;
import static com.DoltishNeighbour.Game.nB;
import static com.DoltishNeighbour.Game.a;
import static com.DoltishNeighbour.Game.b;
import static com.DoltishNeighbour.Game.maze;

public class getMaze {

    private static ArrayList<Integer> directions=new ArrayList<>();

    protected static void generateMaze() {
    ...
    private static void checkIsolated() {
        ...
        for (int i = 1; i < nA-1; i+=2) {
            for (int j = 1; j < nB-1; j+=2) {
                if ((maze[i][j+1]==-2)&&(maze[i+1][j]==-2)&&(maze[i][j-1]==-2)&&(maze[i-1][j]==-2)) {
